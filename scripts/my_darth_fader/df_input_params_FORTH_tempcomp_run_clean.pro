...
function df_input_params_FORTH_tempcomp_run_clean
...
trainingcat = 'training_forth_clean.fits.gz' ; Set rmscurve = '' for white gaussian nosie
...
RedshiftFileName = 'redshifts_forth_clean.fits'
