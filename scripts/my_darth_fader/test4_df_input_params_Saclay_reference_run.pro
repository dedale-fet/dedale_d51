...
function test4_df_input_params_Saclay_reference_run

;; \\ INPUT FILES AND LOCATIONS //
INDIR = './Saclay_reference_run/'                     ; Input directory containing the spectra as FITS files
incat = 'testing_euclid.fits.gz' ; Must specify trainingcat or templatecat, the other may be specified as ''
trainingcat = 'training_euclid_small.fits.gz' ; Set rmscurve = '' for white gaussian nosie
...
lstep = double(8.6858896380771232e-05) ; logarithmic pixel scaling
training_lmin = 1252.5                       ; training set min. wavelength in angstroms
training_lmax =  19992.18713492              ; training set max. wavelength in angstroms
data_lmin = 3000.                       ; data min. wavelength in angstroms
data_lmax = 19499.95755049                  ; data max. wavelength in angstroms
...
regul = 0
EstRed = 1
EstimRedshiftFromNoisyData = 1  ; Set to 1 if you wish to use the noisy data for cross-correlation
...
OUTDIR = './Saclay_reference_run/'                   ; Directory in which to place the outputs of the Darth Fader Run
...
RedshiftFileName = 'redshifts_test4.fits'
