...
;print, "Going into df_del_baseline for the second time"
Contsubdata  = df_del_baseline(Spectra,  nscale=nscale , rms=rms,  baseline=continua)
;print, "Came out of df_del_baseline"
optstring2 =  ' -n ' +  STRC(nscale) + ' -k -K -i20 -C2 -s'  + STRC(nsigma) + ' '
