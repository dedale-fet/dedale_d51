...
function test1_df_input_params_Saclay_reference_run

;; \\ INPUT FILES AND LOCATIONS //
INDIR = './TEST/'
incat = '2018-04-04_testing.fits.gz'
...
; 2018-04-11: REFERENCE RUN THAT IS WORKING: \\ INPUT FILES AND LOCATIONS //
...
OUTDIR = './TEST/'                   ; Directory in which to place the outputs of the Darth Fader Run
...
RedshiftFileName = 'redshifts_test1.fits'
