...
INDIR = './df_data/'                     ; Input directory containing the spectra as FITS files
incat = 'properlyscaled.fits.gz' ; Must specify trainingcat or templatecat, the other may be specified as ''
...
NsigmaPeak = 0.01
Linematch = 0                   ; Peaks detected in wavelet space, but with an amplitude smaller than NsigmaPeak * RMSnoise  
...
OUTDIR = './df_data/'                   ; Directory in which to place the outputs of the Darth Fader Run
