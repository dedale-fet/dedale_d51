...
function df_input_params_Saclay_reference_run
...
trainingcat = 'training_euclid.fits.gz' ; Set rmscurve = '' for white gaussian nosie
...
RedshiftFileName = 'redshifts_euclid_full.fits'
