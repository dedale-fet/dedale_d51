...
INDIR = './2018-03-29_euclid_wide/'                     ; Input directory containing the spectra as FITS files
incat = '2018-03-29_testing_tips.fits.gz' ; Must specify trainingcat or templatecat, the other may be specified as ''
trainingcat = '2018-03-29_training_tips.fits.gz' ; Set rmscurve = '' for white gaussian nosie
rmscurve = '';'2018-03-29_errorcurve_tips_1e18.fits.gz'            
templatecat = '' ;'templates.fits'
componentcat = 'components.fits'
zcat = '2018-03-29_ztrue.fits.gz'

;; \\ INPUT DATA PARAMETERS //

lstep = double(4.7501e-04) ; logarithmic pixel scaling
training_lmin = 1264.040844                       ; training set min. wavelength in angstroms
training_lmax =  18551.825453              ; training set max. wavelength in angstroms
data_lmin = 12468.855292                       ; data min. wavelength in angstroms
data_lmax = 18525.944708                  ; data max. wavelength in angstroms
...
OUTDIR = './2018-03-29_euclid_wide/output_data/'                   ; Directory in which to place the outputs of the Darth Fader Run
